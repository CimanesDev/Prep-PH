      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="border-border/50 bg-card/80 backdrop-blur-sm rounded-2xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-xl font-semibold mt-2">Create your account</CardTitle>
            <CardDescription className="text-sm">Start practicing with personalized AI feedback</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 space-y-3">
              ...
              <Button type="button" onClick={handleGoogleSignup} className="w-full rounded-full bg-white text-neutral-900 hover:bg-white/90 border border-border/50" aria-label="Continue with Google">
